import { a as TABS } from './Tabs-cd5df825.js';
...
function instance$1($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*name, id, elem_id, visible, interactive*/ 453) {
			$$invalidate(9, tab_index = register_tab({ name, id, elem_id, visible, interactive }));
		}

		if ($$self.$$.dirty & /*$selected_tab_index, tab_index, name*/ 1600) {
...
//# sourceMappingURL=Index-bd49679c.js.map
