...
const ENTRY_CSS = "./assets/index-20519b4d.css";
let FONTS;
FONTS = [];
let IndexComponent;
let _res;
...
async function get_index() {
  IndexComponent = (await __vitePreload(() => import('./Index-f4e7a341.js').then(n => n.I),true?["./Index-f4e7a341.js","./Index-c396162c.css"]:void 0,import.meta.url)).default;
  _res();
}
...
//# sourceMappingURL=index-546f83db.js.map
