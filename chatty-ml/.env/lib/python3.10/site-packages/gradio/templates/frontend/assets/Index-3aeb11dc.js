import { w as writable, S as Static } from './Index-f4e7a341.js';
...
function instance$1($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('root_dir' in $$props) $$invalidate(8, root_dir = $$props.root_dir);
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*glob, ignore_glob, root_dir*/ 448) {
			(render_tree());
		}
...
function create_default_slot(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty & /*root_dir*/ 1024) directoryexplorer_changes.root_dir = /*root_dir*/ ctx[10];
...
function create_fragment(ctx) {
	...
	return {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*$$scope, file_count, server, interactive, root_dir, glob, ignore_glob, value, gradio, show_label, label, loading_status*/ 1281969) {
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('root_dir' in $$props) $$invalidate(10, root_dir = $$props.root_dir);
...
//# sourceMappingURL=Index-3aeb11dc.js.map
