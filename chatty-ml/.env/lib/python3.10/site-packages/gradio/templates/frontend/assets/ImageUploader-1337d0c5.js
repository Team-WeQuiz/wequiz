...
import { p as prepare_files, u as upload, n as normalise_file } from './index-546f83db.js';
import { S as SelectSource } from './SelectSource-85b10638.js';
import { D as DropdownArrow } from './DropdownArrow-04b836e1.js';
...
function create_if_block_1$1(ctx) {
	...
	return {
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					listen$1(button, "click", stop_propagation(/*click_handler*/ ctx[18])),
...
// (193:4) {#if video_sources.length === 0}
...
// (196:5) {#each video_sources as source}
function create_each_block(ctx) {
	let option;
	let t0_value = /*source*/ ctx[28].label + "";
	let t0;
	let t1;
	...
	function click_handler_1() {
		return /*click_handler_1*/ ctx[19](/*source*/ ctx[28]);
	}
	...
	return {
		...
		p(new_ctx, dirty) {
			ctx = new_ctx;
			if (dirty & /*video_sources*/ 128 && t0_value !== (t0_value = /*source*/ ctx[28].label + "")) set_data(t0, t0_value);
...
function instance$2($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('include_audio' in $$props) $$invalidate(16, include_audio = $$props.include_audio);
...
//# sourceMappingURL=ImageUploader-1337d0c5.js.map
